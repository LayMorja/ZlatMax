    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    init: function(swiper) {
                        ...
                        const allSlidesItems = document.querySelectorAll(".slider-main-block:not(.swiper-slide-duplicate)");
            ...
            if (document.querySelector(".thumbs-images")) {
                const thumbsSwiper = new core(".main-product__thumbs", {
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                } else console.log("Такого подменю нет");
                e.preventDefault();
            }
